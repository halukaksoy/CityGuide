...
using CityGuide.Business.Business;
using CityGuide.Domain.Interface;
using CityGuide.Infrastructure.AutoMapper;
using AutoMapper;
...
namespace CityGuide.API
{
    public class Startup
    {
        ...
        {
            var securityKey = Encoding.ASCII.GetBytes(Configuration.GetSection("AppSettings:Token").Value);
            services.Configure<CloudinarySettings>(Configuration.GetSection("CloudinarySettings"));
            services.AddDbContext<CityGuideDataContext>(options => options.UseSqlServer(Configuration.GetConnectionString("CityGuideConnection")));
